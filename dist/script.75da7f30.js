...
var TaskList = /*#__PURE__*/function () {
  ...
  _createClass(TaskList, [{
    ...
    value: function addTask(taskName, assignee, status, description) {
      ...
      var task = new _task.default(this.currentId++, // instructs it to add 1 to the Id to get a unique Id for this task getting newly created
...
},{"./task.js":"task.js"}],"display.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = displayAllTasksFromStorage;

var _taskList = _interopRequireDefault(require("./taskList.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var TaskList = new _taskList.default(); // Display all task froms storage

function displayAllTasksFromStorage(listOfCards, openEditModal, deleteTask) {
  var mynewtasks = JSON.parse(window.localStorage.getItem("mytasks")) || _taskList.default.tasks;
...
},{"./taskList.js":"taskList.js"}],"script.js":[function(require,module,exports) {
"use strict";
...
var taskList = new _taskList.default(); // Creates an instance of class BookList. Sets taskList as a variable and attaches it to a new function.
...
(0, _display.default)(listOfCards, openEditModal, deleteTask); // END: DISPLAY TASKS FROM STORAGE ON WEB PAGE LOAD //
// START: EDIT TASK //
...
btnEditUpdate.onclick = function () {
  ...
  if (editTaskName.value == "" || editTaskName.value.length < 8 || editTaskDescription.value == "" || editTaskDescription.value.length < 15 || editAssignee.value == "") {
    ...
    (0, _display.default)(listOfCards, openEditModal, deleteTask);
  }
...
function clearAllFields() {
  ...
  taskDescription.style.borderColor = "#ced4da"; // taskStatus.value = selected;
} // END: CLEAR FIELDS //
...
},{"./taskList.js":"taskList.js","./display.js":"display.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
